<div class='config subsite-support'>
	<div class='config-main-title'>
		...
		<span class='config-title-notice'>
			<span class='user-google-guide-button inner-title' page = 'google_doc_help' 'google_doc_theme_mobile' document_name = 'https://docs.google.com/document/d/1hiM2OIFlCkASMOgnyBsrTVcvICZz26oIze9Cz7p9BI8/pub#h.5bu4gi87qhep'>[show]</span>
		</span>
		</div>
	</div>
	<div class='hidden-google-doc google_doc_help'>	
