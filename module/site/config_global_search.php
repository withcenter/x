 <div class='config-wrapper' style='margin-top: 10px;'>
	...
	<div class='config-container'>
		<div style='margin-bottom: 10px;'><input type='checkbox' name='all_site_search' value=1 <?=meta('all_site_search')?"checked=1":''?> /> <span class='config-name'>전체 사이트 검색</span> &nbsp;&nbsp;&nbsp;전체 사이트 검색을 하시면 검색될 사이트에 지정된 사이트에 관계없이 모든 사이트에서 검색 됩니다.</div>
