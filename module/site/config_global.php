...
<div class='config site-global'>
	...
	<div class='config-main-container'>
		...
		<div class='config-wrapper'>						
			<div class='config-title'>
				...
				<span class='config-title-notice'>
					<span class='user-google-guide-button' page = 'google_doc_global' document_name = 'https://docs.google.com/document/d/1hiM2OIFlCkASMOgnyBsrTVcvICZz26oIze9Cz7p9BI8/pub#h.wmno5pose5c8'>[설명 보이기]</span>
		...
		<?php
			...
			include 'config_global_search.php';
