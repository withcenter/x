...
<? if ( $is_error ) { ?>
	Fix error above.
<? } else { ?>
<a href='?module=update&action=admin_install_direct_submit&source_link=<?=$source_link?>&type=<?=$type?>&theme=y' style="display:inline-block; padding: 1em; border: 1px solid grey; background-color: #efefef;">
