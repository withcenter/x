...
<table id='x-rwd-gallery' cellpadding='0' cellspacing='0' width='100%'>
<tr>
<?
	$count_image = 0;
	...
	<td>
			<div class='post' no="<?=$count_image?>">
				...
				<div class='text'>
					...
					<div class='desc'><a href="<?=$list[$i]['href'] ?>"><?php echo get_text(cut_str(strip_tags($list[$i][wr_content]), 25, '...' )) ?></a></div>
				</div>
			</div>
	</td>
<?php } ?>
