<?
$swfupload_path         = "$board_skin_path/swfupload"; // swfupload 경로
$swfupload_url         = "$board_skin_url/swfupload"; // swfupload 경로
$thumb_width            = "120"; // 썸네일 가로 사이즈
$thumb_height           = "90"; // 썸네일 세로 사이즈
...
if ($wr_id and $w!="r") {
	$board_file_path    = G5_DATA_PATH."/file/$bo_table"; // 파일폴더 경로
	$board_file_url   = G5_DATA_URL."/file/$bo_table"; // 파일폴더 경로
	$sql  = " select * from $g5[board_file_table] where bo_table = '$bo_table' and wr_id = '$wr_id' ";

} else {
	$board_file_path    = G5_DATA_PATH."/guploader"; // 파일폴더 경로
...
<script type="text/javascript" src="<?=$swfupload_url?>/swfupload.js"></script>
<script type="text/javascript" src="<?=$swfupload_url?>/swfupload.swfobject.js"></script>
<script type="text/javascript" src="<?=$swfupload_url?>/swfupload.queue.js"></script>
<script type="text/javascript" src="<?=$swfupload_url?>/fileprogress.js"></script>
<script type="text/javascript" src="<?=$swfupload_url?>/handlers.js"></script>
...
var swfupload_url         = "<?=$swfupload_url?>";
...
var board_file_url        = "<?=$board_file_url?>";
...
SWFUpload.onload = function () {
	var settings = {
		// Flash Settings
		flash_url : "<?=$swfupload_url?>/swfupload.swf",

		// File Upload Settings
		upload_url : "<?=$swfupload_url?>/file_upload.php",
		post_params : {
			"bo_table"         : bo_table,
			"mb_id"            : mb_id,
			"wr_id"            : wr_id,
