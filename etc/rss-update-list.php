...
<?php
$sql = " select wr_id, wr_subject, wr_content, wr_name, wr_datetime, wr_option, wr_link1
            from {$g5['write_prefix']}$bo_table
            where wr_is_comment = 0
            and wr_option not like '%secret%'
            order by wr_num, wr_reply limit 0, 1000 ";
...
<link><?php echo specialchars_replace( $row['wr_link1'] ) ?></link>
