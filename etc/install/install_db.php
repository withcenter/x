...
?>
        ...
        <li>Database configuration is OK</li>
...
?>
        ...
        <li>Data repository creation finished</li>
...
?>
        ...
        <li>Database configuration file has created (<?php echo $file ?>)</li>
