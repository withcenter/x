...
<ul>
	...
	?>
	<?if ( ms::admin() ) { ?><li class='last-item' page='admin-menu'><div class='inner'><a  href='<?=x::url()?>/?module=multi&action=config_global'>사이트 관리<div class='border_left'></div></a></div></li><?}?>
</ul>
