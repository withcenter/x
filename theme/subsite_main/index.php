...
<div id='create-your-site'>
	<a href='<?=x::url()?>/?module=site&action=create'><img src='<?=x::url_theme()?>/img/create_button.png' /></a>
</div>

<div id='banner-wrapper'>
	<a href='<?=x::url()?>/?module=site&action=create'><img src='<?=x::url_theme()?>/img/banner.png' /></a>
</div>
